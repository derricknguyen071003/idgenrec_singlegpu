...
python ../src/main_generative.py \
  ...
  --id_batch_size 1 \
  --rec_batch_size 1 \
  --prompt_file ../prompt_no_user_id.txt \
  --sample_prompt 1 \
  --eval_batch_size 1 \
  --sample_num 1 \
  --max_his 20 \
  ...
  --rec_epochs 10 \
  --alt_style id_first \
#  --id_model_path /home/derrick/Documents/IDGenRec/model/Toys_id_1_rec_10_20250621_090341/model_gen_round3_final.pt \
#  --rec_model_path /home/derrick/Documents/IDGenRec/model/Toys_id_1_rec_10_20250621_090341/model_rec_round3_final.pt \