...
class MultiTaskDataset(Dataset):
    def parse_dataset_args(parser):
        ...
        """
        parser.add_argument("--data_path", type=str, default='/data/local2/jt867/rec_datasets', help="data directory")
        ...
        if args.distributed:
            if self.item_indexing == 'sequential':
                ...
                if self.rank == 0:
                    ...
                    indexing.generative_indexing(self.data_path, self.dataset, self.user_sequence_dict)
                    dist.barrier()
                else:
                    dist.barrier()
