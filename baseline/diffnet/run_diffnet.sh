...
# Run DiffNet2 training and evaluation using existing codebase utilities
...
LOG_FILE="${LOG_DIR}/diffnet2_${DATASET}_${TIMESTAMP}.log"
MODEL_FILE="${MODELS_DIR}/diffnet2_${DATASET}_${TIMESTAMP}.pth"

echo "=========================================="
echo "Starting DiffNet2 Training and Evaluation"
echo "=========================================="
